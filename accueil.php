...
<head>
  ...
  <!-- CDN google fonts -->
  <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Odibee+Sans&display=swap">
</head>
<body>
  <!-- Navbar bootstrap -->
      ...
      <ul class="navbar-nav ml-auto mr-4">
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" style="background-color: #727d87;" aria-labelledby="navbarDropdownMenu">
            ...
            <a class="dropdown-item text-danger" href="home.php">Me déconnecter <i class="fas fa-sign-out-alt"></i></a>
          </div>
        </li>
        <li>
