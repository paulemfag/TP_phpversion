    ...
    <body>
        ...
        <div id="suscribeItems">
            ...
            <form class="container" id="suscribers" method="post" action="#" novalidate>
                <div class="form-group">
                    ...
                    <input id="suscribepseudo" name="suscribepseudo" class="col-12 text-center mt-1 inputColor" type="text" placeholder="Pseudo" value="<?= $suscribepseudo ?>" required>
                </div>
                <div class="form-group">
                    ...
                    <input id="suscribemailbox" name="suscribemailbox" class="col-12 text-center mt-1 inputColor" type="email" placeholder="exemple@mail.com" value="<?= $suscribemailbox ?>" required>
                </div>
                <div class="form-group">
                    ...
                    <input id="suscribepassword" name="suscribepassword" class="col-12 text-center mt-1 inputColor" type="password" placeholder="*****" value="<?= $suscribepassword ?>" required>
                </div>
                <div class="form-group">
                    <input id="suscribepasswordconfirmation" name="suscribepasswordconfirmation" class="col-12 text-center mt-1 inputColor"inputColor type="password" placeholder="Confirmation du mot de passe" value="<?= $suscribepasswordconfirmation ?>" required>
                </div>
        ...
        <div id="connectItems">
            ...
            <form class="container" action="#" method="post" novalidate>
                <div class="form-group">
                    ...
                    <input id="pseudo" name="pseudo" class="col-12 text-center mt-1 inputColor" type="text" placeholder="Pseudo" value="<?= $pseudo ?>" required>
                </div>
                <div class="form-group">
                    <label class="text-light" for="mailbox">Adresse mail :</label>
                    <span class="text-danger float-right"><?= ($errors['mailbox']) ?? '' ?></span>
                    <input id="mailbox" name="mailbox" class="col-12 text-center mt-1 inputColor" type="email" placeholder="Adrese mail" value="<?= $mailbox ?>" required>
                </div>
                <div class="form-group">
                    <label class="text-light" for="password">Mot de passe :</label>
                    <span class="text-danger float-right"><?= ($errors['password']) ?? '' ?></span>
                    <input id="password" name="password" class="col-12 text-center mt-1 inputColor" type="password" placeholder="Mot de passe" value="<?= $password ?>" required>
                </div>
        ...
        <form class="container" id='forgottenPassword' method="post" novalidate>
            ...
            <div class="form-group">
                ...
                <input id="recuperationMailbox" class="col-12 inputColor" name="recuperationMailbox" type='text' value="<?= $recuperationMailbox ?>" required>
            </div>
            <span class="text-success float-right"><?= ($errors['isok']) ?? '' ?></span>
